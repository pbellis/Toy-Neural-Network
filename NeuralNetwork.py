...
class NeuralNetwork(object):
    ...
    def __init__(self, layer_dims, epsilon, activation_function, l2 = 0):
    ...
    def back_propagate(self, X, y, activations):                
        ...
        for k in xrange(self.output_layer, self.input_layer, -1):
            ...
            dW[k-1] = self.epsilon * (activations[k-1].T).dot(beta[k])
    ...
    def fit(self,X,y,num_epochs):   
        ...
        for epoch in xrange(num_epochs):
            ...
            for l in xrange(self.output_layer):
                self.W[l] = (1 - (self.l2 * self.epsilon / n) ) * self.W[l] - dW[l]
                self.b[l] -= db[l]
    ...
    def compute_cost(self, X, y):
        ...
        return 1./num_samples * data_loss * (w_sqr * self.l2  / (2*num_samples))
